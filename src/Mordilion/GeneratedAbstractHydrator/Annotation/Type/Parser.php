...
final class Parser extends \Hoa\Compiler\Llk\Parser
{
    public function __construct()
    {
        parent::__construct(
            ...
            [
                'type' => new \Hoa\Compiler\Llk\Rule\Choice('type', ['simple_type', 'complex_type'], null),
                ...
                19 => new \Hoa\Compiler\Llk\Rule\Token(19, 'parenthesis_', null, -1, false),
                20 => new \Hoa\Compiler\Llk\Rule\Token(20, 'comma', null, -1, false),
                21 => new \Hoa\Compiler\Llk\Rule\Concatenation(21, [20, 'type'], '#complex_type'),
                22 => new \Hoa\Compiler\Llk\Rule\Repetition(22, 0, -1, 21, null),
                23 => new \Hoa\Compiler\Llk\Rule\Token(23, '_parenthesis', null, -1, false),
                'complex_type' => new \Hoa\Compiler\Llk\Rule\Concatenation('complex_type', [18, 19, 'type', 22, 23], null),
            ],
            [
            ]
        );

        $this->getRule('type')->setPPRepresentation(' simple_type() | complex_type()');
